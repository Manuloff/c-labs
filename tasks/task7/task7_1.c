...
void task7_1() {
    ...
    while (1) {
        ...
        printf("Можно использовать заранее заготовленный массив из файла data/task7_1.txt\n");
        ...
        if (useFile == 0) {
            ...
            FILE *file = fopen("../data/task7_1.txt", "r");
            if (!file) {
                printf("Не удалось открыть файл task7_1.txt\n");
                continue;
            }
